export namespace Const {
  ...
  export var LONG_HELP_MESSAGE: string = "CORE COMMANDS (don't forget a terminating semicolon!)\n"
  ...
  + "Likes(drinker, beer)\n\n"
  + "SUBQUERIES\n"
  + "subquery: Lists all subquery definitions\n"
  + "subquery [SUBQUERYNAME] [DEFINITION]: Defines a new subquery.\n"
